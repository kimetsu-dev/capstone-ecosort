  ...
  return (
    <div className={`${styles.page} flex items-center justify-center`}>
      <div className="text-center">
        <div className={`inline-block w-8 h-8 border-4 border-current border-t-transparent rounded-full animate-spin ${styles.text.accent}`}></div>
...
// Enhanced ProtectedRoute with theme-aware loading
...
// Enhanced ThemedAppWrapper with background animations
